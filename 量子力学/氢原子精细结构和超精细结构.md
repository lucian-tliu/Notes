...
$$
\left\{\left|n=2;l=0;m_L=0;m_S=\pm\frac{1}{2};m_I=\pm\frac{1}{2}\right\rangle\right\}
$$
($4$ 维的 $2s$ 次壳层)
$$
\left\{\left|n=2;l=0;m_L=0,\pm1;m_S=\pm\frac{1}{2};m_I=\pm\frac{1}{2}\right\rangle\right\}
$$
($12$ 维的 $2p$ 次壳层)
...
氢原子中存在从 $f=1$ 到 $f=0$ 的超精细跃迁，是目前实验上测得有效数字最多的一个物理量
$$
